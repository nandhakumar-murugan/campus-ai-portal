...
try:
    ...
    print("✅ REAL NEURAL LLM MODEL LOADED INTO SYSTEM RAM!")
...
class LLMRequestHandler(BaseHTTPRequestHandler):
    def do_POST(self):
        ...
        try:
            ...
            messages = [
                {"role": "system", "content": "You are a helpful AI assistant hosted on the campus network."},
            ...
            generated_text = output[0]['generated_text'][len(formatted_prompt):].trim() if 'generated_text' in output[0] else "Response generated."
...
if __name__ == '__main__':
    ...
    print("🚀 REAL NEURAL LLM SERVER ACTIVE ON 127.0.0.1:11434")
    httpd.serve_forever()
